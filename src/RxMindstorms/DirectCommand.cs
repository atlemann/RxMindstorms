...
namespace RxMindstorms
{
	...
	public sealed class DirectCommand
	{
		...
		{
			Command c = _brick.CreateCommand(CommandType.DirectReply, 0x10, 0);
		...
		{
			Command c = _brick.CreateCommand(CommandType.DirectReply, 1, 0);
		...
		{
			Command c = _brick.CreateCommand(CommandType.DirectReply, 2, 0);
		...
		{
			Command c = _brick.CreateCommand(CommandType.DirectReply, 4, 0);
		...
		{
			Command c = _brick.CreateCommand(CommandType.DirectReply, 0x7f, 0);
